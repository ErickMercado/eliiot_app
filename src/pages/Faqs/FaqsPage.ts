...
export default class FaqsPage extends Vue {        
    ...
    private faqs : Map<String, String> = new Map([
        [ 
            ...
            'Estoy de tu lado, entiendo por lo que estás pasando no es agradable, por eso quiero negociar acuerdos de pago, descuentos o ampliar tus plazos con las instituciones. ¡Ah! Y si hay marca negativa, también te ayudo a borrarla; en pocas palabras te daré opciones según lo que te convenga.' 
        ],
        [
